...
// SECURE OFFLINE SESSION VERIFICATION USING CRYPTOGRAPHIC SHA-256 SIGNATURES
const SIGNATURE_SECRET_KEY = import.meta.env.VITE_CLIENT_SECRET || 'inmarket_offline_fallback_2026';

/**
 * Standard self-contained synchronous SHA-256 implementation.
 * Eliminates vulnerabilities of FNV-1a and avoids external payload/library dependencies.
 */
